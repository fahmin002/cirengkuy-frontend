...
import { RiBarChartBoxLine, RiBarChartFill, RiDashboardHorizontalFill, RiDashboardHorizontalLine } from 'react-icons/ri';
        ...
        location.pathname !== '/admin/login' ? (
          <>
            <div>
              ...
              <nav
                className='fixed rounded-t-4xl shadow-2xl bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 flex justify-center z-10'
              >
