...
export default function Checkout() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // reset form & cart
      setForm({ name: '', phone: '', address: '', notes: '', paymentMethod: 'qris', deliveryMethod: 'pickup', schedule: 'sekarang', scheduleDateTime: '' });
      emptyCart();
  ...
  return (
    <div className="p-4 pb-24">
      <div className='pb-26'>
        <h1 className="text-xl font-bold google-sans-flex-bold text-left">Checkout</h1>

        {cart.length === 0 && (
          <p className="text-gray-500 google-sans-flex-regular text-left">Keranjang kosong 😢</p>
        )}
          ...
          {form.schedule === 'besok' && (
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) => setForm({ ...form, scheduleDateTime: e.target.value })}
              />
            </div>
          )}
        ...
        <div className='mb-8'>
          {cart.map(item => (
            ...
            >
              <div>
                <img src="https://i.ytimg.com/vi/CaqSlzAgkN4/maxresdefault.jpg" className='rounded-4xl object-cover h-16 shadow-md' alt="" srcset="" />
              </div>
              <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input type="number" value={(item.qty)} onChange={(e) => updateQty(item.id, parseInt(e.target.value) || 0)} className="font-bold text-center border border-gray-300 rounded-md w-10" />
