...
export function ProductMonthlyReport() {
    ...
    const fetchReport = async () => {
        try {
            ...
            const res = await api.get(
                `/reports/admin/product-performance-monthly?month=${month}`
            );
    ...
    const totalSold = products.totalSoldItems;

    const soldProducts = products.soldProducts;

    const unsoldProducts = products.unsoldProducts;
            ...
            <div className="min-h-screen bg-gray-50 lg:w-lg rounded-xl pb-24">
                <div className="p-5 border-b border-gray-100">
                    <h1 className="text-3xl font-black text-gray-900 text-left">
                        Performa Produk Bulanan
                    </h1>

                    <p className="text-gray-500 mt-1 text-left">
                        Penjualan produk pada bulan yang dipilih
                    </p>
...
export default ProductMonthlyReport;
